...
Реализуйте следующие аналитические витрины:
...
| Баллы | Требования                                                           |
|-------|----------------------------------------------------------------------|
| 6-7 | Макрос + пакеты (dbt_utils, dbt_date) + schema.yml с тестами         |
| 8-9 | + dbt_expectations/elementary/dbt_project_evaluator + singular tests |
| 10 | + unit tests + sqlfluff + .pre-commit-config.yaml + Makefile         |
